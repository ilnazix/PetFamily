...
internal static class QueryExtensions
{
    ...
    public static GetMyVolunteerRequestsQuery ToQuery(
        this GetMyVolunteerRequestsRequest request, Guid userId)
        => new(userId, request.Status, request.PageNumber, request.PageSize);
}
